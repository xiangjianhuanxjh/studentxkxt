...
<div id="divstuinfo"  style="padding: 1px 0px 0px 2px; text-align: center;">
  ...
  <div style="color:Red; font-weight:bold; line-height:23px;">
    <a href="${pageContext.request.contextPath}/SelectCourseServlet" style="color:Red;">[进行选课]</a>&nbsp;||&nbsp;
...
<div id="main">
  <table>
    ...
    <%
      ArrayList<CourseScheduleBean> arrayList = (ArrayList<CourseScheduleBean>) session.getAttribute("studentcourselist");
    ...
    <tr>
      ...
      <td><a href="${pageContext.request.contextPath}/DelCourseServlet?Kh=<%=courseScheduleBean.getKh()%>&Gh=<%=courseScheduleBean.getGh()%>">退课</a></td>
    </tr>
    <%
      }
    %>
